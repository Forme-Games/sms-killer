...
{
cd bin
cp sms-killer /usr/local/bin
chmod +x /usr/local/bin/sms-killer
cp sms-killer /bin
chmod +x /bin/sms-killer
cp sms-killer /data/data/com.termux/files/usr/bin
chmod +x /data/data/com.termux/files/usr/bin/sms-killer
} &> /dev/null
